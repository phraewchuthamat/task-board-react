...
export default function ColumnMenu({ onEdit, onDelete }: ColumnMenuProps) {
    return (
        <Menu as="div" className="relative inline-block text-left">
            ...
            >
                <Menu.Items className="absolute right-0 z-50 mt-1 w-48 origin-top-right divide-y divide-gray-100 rounded-lg bg-app-surface shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none border border-app-border">
                    <div className="p-1">
                        <Menu.Item>
                            {({ active }) => (
                                <button
